...
-- Copiando estrutura do banco de dados para searchdb
CREATE DATABASE IF NOT EXISTS `searchdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `searchdb`;

-- Copiando estrutura para tabela searchdb.cidade
...
-- Copiando dados para a tabela searchdb.cidade: ~14 rows (aproximadamente)
...
-- Copiando estrutura para tabela searchdb.estado
...
-- Copiando dados para a tabela searchdb.estado: ~27 rows (aproximadamente)
